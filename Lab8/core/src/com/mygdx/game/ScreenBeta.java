...
public abstract class ScreenBeta implements Screen, InputProcessor {
    ...
    Container<Table> gameTableContainer;
    ...
    ScreenBeta()
    {
        ...
        gameTableContainer = new Container<Table>();

        float cw2 = WIDTH * 0.5f;
        float ch2 = HEIGHT * 1.f;
        ...
        gameUiTable.setSize(WIDTH, HEIGHT);
        gameUiTable.setBounds(0, 0, Gdx.graphics.getWidth() , Gdx.graphics.getHeight());

        gameTableContainer.setActor(gameUiTable);
